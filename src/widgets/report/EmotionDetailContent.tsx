...
export default function EmotionDetailContent({ emotionId }: EmotionDetailContentProps) {
  ...
  const { data, isLoading } = useQuery({
    ...reportQueries.emotionDetail(token || '', numericEmotionId, year, month),
    enabled: !!token && Number.isFinite(numericEmotionId),
  });
    ...
    <div className="flex flex-1 flex-col bg-white">
      ...
      <div className="border-b-[5px] border-[#F7F8FA] px-4 pt-3 pb-5">
        <div className="flex items-center gap-4">
          {emotionName && <EmotionIcon name={emotionName} size={48} />}
