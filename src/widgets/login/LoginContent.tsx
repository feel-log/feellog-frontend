  ...
  return (
    <div className={"login__content__wrapper relative h-[calc(100vh_-_60.99px)]"}>
      ...
      <div className={"login__part absolute bottom-10 left-0 right-0 flex flex-col items-center gap-3"}>
        <SocialLoginButton social={"kakao"} imageUrl={"/svg/kakaotalk.svg"} text={"카카오로 로그인"} color={"#fee500"} textColor={"#000"} />
        <SocialLoginButton social={"google"} imageUrl={"/svg/naver.svg"} text={"네이버로 로그인"} color={"#05ac4f"} textColor={"#fff"} />
