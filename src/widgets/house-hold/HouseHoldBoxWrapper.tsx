  ...
  return (
    <div className={'house__hold__box__wrapper'}>
      <HouseHoldBox>
        ...
        <div
          className={
            "clover absolute top-0 right-10 bottom-0 my-auto h-[56px] w-[56px] bg-[url('/svg/icon_fourLeafLover.png')] bg-cover bg-center"
          }
        ></div>
      </HouseHoldBox>
      <HouseHoldBox isAnchor anchor={"/jichul"}>
        <div className={"export_money flex flex-col mb-5"}>
